...
try {
  ...
  const testCommand = 'npx jest src/lib/testing/__tests__/ContextMockValidator.test.ts --verbose';
  ...
  try {
    const altCommand = 'npx jest --testNamePattern="ContextMockValidator" --verbose';
