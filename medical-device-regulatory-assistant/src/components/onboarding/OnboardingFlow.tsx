...
const onboardingSteps: OnboardingStep[] = [
  {
    ...
    description:
      'Your AI-powered companion for medical device regulatory pathways',
    icon: Shield,
    content: (
      <div className="space-y-4 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Our AI assistant helps regulatory affairs managers find predicate
            devices, analyze substantial equivalence, and navigate FDA
          ...
          <div className="flex items-start justify-between mb-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Class II ECG Monitor
              </p>
            </div>
            <Badge variant="secondary">In Progress</Badge>
          </div>
          <p className="text-sm text-muted-foreground">
            Intended Use: Continuous monitoring of cardiac rhythm for
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 border rounded-lg p-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Specialized in FDA 510(k) pathways
              </p>
            </div>
          </div>
          <div className="bg-white/50 rounded p-3 text-sm">
            ...
            <div className="space-y-1 font-mono text-xs">
              <div>
                <span className="text-blue-600">/predicate-search</span> Find
                similar devices
              </div>
              <div>
                <span className="text-green-600">/classify-device</span>{' '}
                Determine device class
              </div>
              <div>
                <span className="text-purple-600">/compare-predicate</span>{' '}
                Analyze differences
              </div>
              <div>
                <span className="text-orange-600">/find-guidance</span> Search
                FDA guidance
              </div>
            </div>
          </div>
      ...
      <div className="space-y-4">
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          ...
          <p className="text-sm text-green-700">
            Every AI action is logged with complete reasoning traces and source
            citations for regulatory inspections.
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-start gap-2">
              ...
              <div>
                <strong>AI Decision Reasoning:</strong> Complete explanation of
            ...
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-green-500 mt-0.5" />
              <div>
                <strong>Source Citations:</strong> Direct links to FDA documents
            ...
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-green-500 mt-0.5" />
              <div>
                <strong>Confidence Scores:</strong> Numerical confidence for all
                recommendations
              </div>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-green-500 mt-0.5" />
              <div>
                <strong>Human Oversight:</strong> Required approval for critical
